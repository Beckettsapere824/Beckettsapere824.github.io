(() => {
  const translations = {
    en: {
      ...
      room4Title: 'Open Studio', room4Desc: 'A working space for research, writing, technical exploration and collaborations not yet constrained by a category.', room4Link: 'View contact options',
    ...
    'zh-CN': {
      ...
      room4Title: '开放工作室', room4Desc: '用于研究、写作、技术探索，以及尚未被任何单一类别限制的合作。', room4Link: '查看联系方式',
    ...
    'zh-TW': {
      ...
      room4Title: '開放工作室', room4Desc: '用於研究、寫作、技術探索，以及尚未被任何單一類別限制的合作。', room4Link: '查看聯絡方式',
